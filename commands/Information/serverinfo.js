const { Client, SlashCommandBuilder, EmbedBuilder, ChannelType, GuildVerificationLevel, GuildExplicitContentFilter, GuildNSFWLevel } = require("discord.js");
...
module.exports = {
    ...
    async execute (interaction, client) {
        ...
        interaction.reply({ embeds: [
            new EmbedBuilder()
                .setColor("c5a0c1")
                .setTitle(`Information from ${guild.name}`)
                ...
                .addFields(
                    ...
                    { name: "Characteristics", value: guild.features?.map(feature => `- ${toPascalCase(feature, " ")}`)?.join("\n") || "None", inline: true },
                    {
                        name: "Security",
                        value: [
                    ...
                    {
                        name: `Channels, Topics and Categories (${totalChannels})`,
                        value: [
